...
print('summary_spend', summary.json().get('spend'))
print('roas_status', roas.status_code)
print('roas_first', roas.json()[0].get('roas') if roas.json() else None)
print('orders_status', orders.status_code)
print('orders_count', orders.json().get('count'))
